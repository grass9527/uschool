package com.uschool.esearch.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo createAI(){
        return new ApiInfoBuilder().title("Uschool项目的App接口文档").//设置标题
    ...
    public Docket createD(){
        return new Docket(DocumentationType.SWAGGER_2).//指定生成那种类型的文档
                ...
                .select().apis(RequestHandlerSelectors.basePackage("com.uschool.esearch.controller")).//扫描接口所在的包
                        build();
    }
}
